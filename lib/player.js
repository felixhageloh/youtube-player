...
(function() {
  ...
  this.Player = function(domEl, videoId, options) {
    var Slider, api, controls, destroy, init, newYTPlayer, onPlayerStateChange, onScrubberChange, onVolumeSliderChange, pauseButton, play, playButton, playbackPct, player, playerEl, playerReady, scrubber, scrubberEl, startUpdating, stopUpdating, thumbnailUrl, updateInterval, updateTimer, volume, volumeEl, volumeSlider;
    if (options == null) {
      options = {};
    }
    domEl = $(domEl);
    ...
    onPlayerStateChange = function(event) {
      switch (event.data) {
        ...
        case event.data === YT.PlayerState.BUFFERING:
          return domEl.addClass('buffering');
        case event.data === YT.PlayerState.PAUSED:
