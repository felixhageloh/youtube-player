...
(function() {
  ...
  this.Player = function(domEl, videoId, options) {
    var Slider, api, controls, destroy, init, newYTPlayer, onPlayerStateChange, onScrubberChange, onVolumeSliderChange, pauseButton, play, playButton, playbackPct, player, playerEl, playerReady, playing, scrubber, scrubberEl, startUpdating, stopUpdating, thumbnailUrl, updateInterval, updateTimer, volume, volumeEl, volumeSlider;
    domEl = $(domEl);
    options = $.extend({
      videoId: videoId,
      cropX: 0,
    ...
    init = function() {
      ...
      setTimeout(function() {
        ...
        return volumeSlider = Slider(volumeEl, onVolumeSliderChange);
      });
      return newYTPlayer();
    };
