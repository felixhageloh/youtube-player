...
(function() {
  ...
  this.Player = function(domEl, videoId, options) {
    var Slider, api, controls, destroy, init, newYTPlayer, onPlayerStateChange, onScrubberChange, onVolumeSliderChange, pauseButton, play, playButton, playbackPct, player, playerEl, playerReady, playing, quality, scrubber, scrubberEl, startUpdating, stopUpdating, thumbnailUrl, updateInterval, updateTimer, volume, volumeEl, volumeSlider;
    domEl = $(domEl);
    options = $.extend({
      videoId: videoId,
      cropX: 0,
